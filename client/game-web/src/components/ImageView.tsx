...
import imagePath10 from "components/images/e78522eb-46d3-4edb-8873-7970dc891e27.png";
import imagePath11 from "components/images/f1af7062-0282-47a8-8456-4e1b598ed64c.png";
...
export function getImagePath(id: string){
    ...
    dict.set("e78522eb-46d3-4edb-8873-7970dc891e27", imagePath10);
    dict.set("f1af7062-0282-47a8-8456-4e1b598ed64c", imagePath11);
